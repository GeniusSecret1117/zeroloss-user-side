...
import { Typography, Paper, Input, Tabs, Tab, Popover, Button } from '@mui/material';
...
import YourProfitCard from './components/yourProfitCard';
...
function ReferralStatement(props) {
  const { t } = useTranslation('referralStatementPage');
  ...
  const handleOnChange = (ranges) => {
    ...
    if (
      selection.startDate &&
      selection.endDate &&
      (selection.startDate.getTime() !== selection.endDate.getTime() || !isStartDate)
    ) {
      setDtStart(selection.startDate);
      setDtEnd(selection.endDate);
    } else {
      ...
      content={
        <div className="w-full container p-12">
          <div className="flex items-center mt-[20px]">
            <DescriptionOutlinedIcon className="text-[40px] text-[#032123]" />
          ...
          <div className="flex justify-between mt-[20px] items-center flex-wrap gap-8">
            ...
            <div className="flex gap-8 flex-wrap">
              ...
              <div className="flex gap-8 items-center">
                ...
                >
                  <Typography className="text-[14px] font-medium" color="success">
                    {formatDate(dtStart)}
                  </Typography>
