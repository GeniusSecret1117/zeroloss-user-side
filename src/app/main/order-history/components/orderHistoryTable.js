          ...
          <Table className="w-full" sx={{ minWidth: 650 }}>
            <TableHead>
              <TableRow>
                ...
                <HeaderTableCell align="right">Avg. Price</HeaderTableCell>
                <HeaderTableCell align="right">Executed</HeaderTableCell>
              ...
              {currentData.map((item, index) => (
                <TableRow key={index}>
                  ...
                  >
                    <div
                      className={clsx(
                        "inline-flex min-w-[60px] justify-center items-center border rounded-[6px] p-[8px] ",
                        item.side === "BUY"
