              ...
              <TableRow>
                ...
                <HeaderTableCell>
                  <div className="flex w-full justify-end items-center gap-8">
                    <div className="flex items-center gap-8">
                      <AttachMoneyOutlinedIcon sx={{ fontSize: 18 }} color="primary" />
                ...
                >
                  <div className="flex w-full justify-end items-center gap-8">
                    <div className="flex items-center gap-8">
                      ...
                      <Typography>Zeroloss %</Typography>
                    </div>
                    <IconButton color="primary">
                      <RxCaretSort className="text-[24px]" />
                    </IconButton>
                ...
                <TableRow key={index}>
                  ...
                  >
                    <div className="flex gap-8">
                      ...
                      <SiBinance className="text-[24px] text-[#032123]" />
                  ...
                  <BodyTableCell
                    ...
                    className={clsx(index === currentData.length - 1 && 'border-none')}
                  >
                    <Typography className="number">{formatNumberWithOutDecimal(item.total_profit)}</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    className={clsx(index === currentData.length - 1 && 'border-none')}
                  >
                    <Typography className="number">{formatNumberWithOutDecimal(item.your_amount)}</Typography>
                    <Typography>({item.your_percentage}%)</Typography>
                  </BodyTableCell>
                  <BodyTableCell
                    align="right"
                    className={clsx(index === currentData.length - 1 && 'border-none')}
                  >
                    <Typography className="number">{formatNumberWithOutDecimal(item.zero_loss)}</Typography>
                    <Typography>({item.zero_loss_percentage}%)</Typography>
                  </BodyTableCell>
                </TableRow>
              ))}
            </TableBody>
